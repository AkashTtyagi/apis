 ...
 */
router.post('/workflows/create', expenseWorkflowController.createWorkflow);

/**
 * Get all workflows with filters
 * POST /api/expense/admin/workflows/list
 */
router.post('/workflows/list', expenseWorkflowController.getAllWorkflows);

/**
 * Get workflow details
 * POST /api/expense/admin/workflows/details
 */
router.post('/workflows/details', expenseWorkflowController.getWorkflowDetails);

/**
 * Update workflow
 * POST /api/expense/admin/workflows/update
 */
router.post('/workflows/update', expenseWorkflowController.updateWorkflow);

/**
 * Delete workflow
 * POST /api/expense/admin/workflows/delete
 */
router.post('/workflows/delete', expenseWorkflowController.deleteWorkflow);

/**
 * Clone workflow
 * POST /api/expense/admin/workflows/clone
 */
router.post('/workflows/clone', expenseWorkflowController.cloneWorkflow);

/**
 * Get dropdown data for workflow forms
 * POST /api/expense/admin/workflows/dropdown
 */
router.post('/workflows/dropdown', expenseWorkflowController.getDropdownData);

/**
 * Manage category to workflow mapping
 * POST /api/expense/admin/workflows/category-mapping/manage
 */
router.post('/workflows/category-mapping/manage', expenseWorkflowController.manageCategoryMapping);

/**
 * Get applicable workflow for expense
 * POST /api/expense/admin/workflows/get-applicable
 */
router.post('/workflows/get-applicable', expenseWorkflowController.getApplicableWorkflow);
